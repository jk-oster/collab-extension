    ...
    <div>
      ...
      <div>
        <label for="updateInterval">
          Update interval
          <select id="updateInterval" name="updateInterval" v-model="store.updateInterval" @change="restartInterval()">
      ...
      <div>
        <label for="showSelf">
          Show own cursor
          <input id="showSelf" name="showSelf" v-model="store.showSelf" type="checkbox" @change="saveSettings()"/>
        </label>
      </div>
      <div>
